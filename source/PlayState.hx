...
class PlayState extends MusicBeatState
{
	...
	public static var ratingStuff:Array<Dynamic> = [
		["I'll shoot!", 0.2], //From 0% to 19%
		['Shit', 0.4], //From 20% to 39%
		['Bad', 0.5], //From 40% to 49%
		['Bruh', 0.6], //From 50% to 59%
		['Seriously, Comrade?', 0.69], //From 60% to 68%
		['Nice', 0.7], //69%
		['Try Harder, Comrade', 0.8], //From 70% to 79%
		['Do Better, Comrade', 0.9], //From 80% to 89%
		['Good Enough, Comrade!', 1], //From 90% to 99%
		['Russia Approves!', 1] //The value on this one isn't used actually, since Perfect is always "1"
	];
